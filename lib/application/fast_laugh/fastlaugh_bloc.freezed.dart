...
mixin _$FastlaughState {
  ...
  List<int> get likedVideoIds => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      isError: isError == freezed
          ...
          : isError // ignore: cast_nullable_to_non_nullable
              as bool,
      likedVideoIds: likedVideoIds == freezed
          ? _value.likedVideoIds
          : likedVideoIds // ignore: cast_nullable_to_non_nullable
              as List<int>,
    ));
  }
}
...
class _$_Initial implements _Initial {
  ...
  @override
  String toString() {
    return 'FastlaughState(videoList: $videoList, isLoading: $isLoading, isError: $isError, likedVideoIds: $likedVideoIds)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._likedVideoIds, _likedVideoIds));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_likedVideoIds));
...
abstract class _Initial implements FastlaughState {
  const factory _Initial(
      ...
      final List<int> likedVideoIds}) = _$_Initial;
